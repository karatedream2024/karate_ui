  ...
  return (
    ...
    <div
      ...
      <div className="flex flex-col justify-beteween">
        <div>
          ...
          <div className="flex py-2">
            <span className="h4">Date: <span className="h5"> 22-10-2024 - 22-10-2024 </span></span>
          </div>

          <div>
            <img className="rounded-lg w-[100%] h-96" src="https://images.pexels.com/photos/691637/pexels-photo-691637.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
          </div>
      ...
      <div className="flex flex-col justify-between">
        <div>
          <div className="h3">
            Leader Ship by "Ranjith Kumar"
          </div>
          <div className="mt-5 p ">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda aut quos omnis quaerat quasi atque quas temporibus.
          </div>
          ...
          <div className="text-center mt-10 text-logo_yellow">
            "Win or lose, keep fighting; every step brings you closer to greatness."
          </div>
