    ...
    <div>
      ...
      <div className='relative'>
        ...
        <div className="grid grid-cols-12 ">
          ...
          <div className="col-span-12  lg:col-span-8 md:p-10 ">
            <div className="grid grid-cols-12 shadow-lg rounded-xl  w-[100%] mt-10">
              <div className="col-span-12 md:col-span-5 lg:col-span-5">
                <img className="w-full h-80" src="https://images.pexels.com/photos/8190816/pexels-photo-8190816.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
              </div>
              <div className="col-span-12 md:col-span-7 p-5">
                <div className="h-full flex flex-col justify-start">
                  <div>
                    <div className='h2'>Today training in OOty</div>

                  </div>

                  <h2 className="text-cyan-600 pt-3 h3">Date : <span>31-09-2024</span></h2>

                  <div className="pt-3 ">
                    Visiting With Our Karate Family
                  </div>
                  <div className="flex  justify-center items-center h-full p h5">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Non debitis id odit voluptate molestiae deleniti provident laboriosam nulla autem sunt? Quibusdam illum inventore rerum excepturi magni culpa cum, quis corporis.
                  </div>
                  <div>
                    Train your self for the upcoming month
                  </div>
                </div>
          ...
          <div className={`${hideBlog ? "" : "hidden"} col-span-4 p-5   lg:block relative`}>
            <div className="   fixed  m-10 lg:fixed shadow-xl bg-white  lg:bg-none p-5">
