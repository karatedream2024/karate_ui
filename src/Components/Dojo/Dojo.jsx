  ...
  getdojodata?.data?.map((data)=>(
      ...
      <div data-aos="fade-up" className='shadow-lg rounded-md bg-background'>
        <div className='flex justify-center relative group'>
          ...
          <div className=" absolute group-hover:bg-primary  duration-1000 group-hover:rounded-t-md group-hover:bg-logo_yellow h-0 bottom-0 group-hover:h-full w-full ">
