  ...
  const cardData = [
    {
      ...
      image: "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8d29tZW58ZW58MHx8MHx8fDA%3D"

    },
    {
      title: 'Women Karate',
      desc: "Empower yourself with karate—enhancing self-defense skills, confidence, and mental strength.",
      image: "https://images.unsplash.com/photo-1571210862729-78a52d3779a2?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    },
    {
      title: 'Men Karate',
                ...
                <div className='grid  grid-cols-1 md:grid-cols-3 md:w-[100%] lg:w-[1024px] md:gap-5  lg:gap-24 text-center' >
                  {
                    cardData.map((card, index) => (
                      <div
                      data-aos={index == 0 ? "fade-up-right" : index == 2 ? "fade-up-left" : "fade-up"}
                    ...
                    ' >
                        ...
                        <div className='h-[250px] group-hover:opacity-100 opacity-0 duration-500 w-full absolute top-0 left-0 flex justify-center items-center p-1' >
                          <img className=' rounded-md border-1 border-[#005691] h-[240px]' src={`${card.image}`} alt="" />
                        </div>
                        {/* <div>
                        <img className=''
                         src="https://images.pexels.com/photos/6295857/pexels-photo-6295857.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                      </div> */}
                        <div>
  ...
  <div  class="absolute top-0 right-0 md:hidden">
    {
     ...
     data-aos-duration={i == 0 ? 1000 : i == 1 ? 1500 : 2000}
          ...
          class="relative mt-5 flex justify-end">
          <div class={`${v.width} relative flex h-[25px] w-[120px] bg-white items-center rounded-bl-lg bg-green-300 pl-5 text-[12px] font-semibold shadow-md shadow-green-300`}>
            {v?.title}
            <span class="absolute top-[98%] left-0">
              ...
              <img className='bg-cover h-[250px]  md:h-[550px]  w-[100%] bg-black ' src={meditate} alt="" />
            ...
            <div className='absolute top-10 md:top-10  h-[100%]  w-[100%]  '>
              <div className='w-full' >
                ...
                <div className='h5  text-white   '>
                  ...
                  <div data-aos="fade-left"  className='text-lg md:h1 p-[5%] md:pl-[15%] md:mt-16 md:py-10 lg:py-10 text-[#E7E8F5] '>
                   <span className='' > <span data-aos="fade-right" >  Karate </span> - <span  data-aos="fade-right"  > Self Defence </span> </span>
                  </div>
                </div>

                <div  data-aos="fade-right" className='pl-[10%] md:pl-[35%]'>
                  <div className='flex mt-0 md:pl-10  lg:mt-10  '>
                    <div data-aos="fade-in" onClick={() => navigate('/contacts')} className='text-[12px] font-bold md:h5 border hover:scale-105 duration-500 cursor-pointer hover:bg-logo_green bg-logo_green/70 rounded-md !text-white border-logo_green h-8 md:h-10 w-[90px] md:w-[120px] flex items-center justify-center'>
                      Contact us
                    </div>
      ...
      className='h-96 rounded-md  hover:shadow-logo_blue duration-1000 flex-col justify-between p-5 shadow-lg ' src={longmaster} alt="" />
                </div>
                <div>
                  <div data-aos="fade-left" data className=' flex flex-col justify-between  hover:shadow-logo_blue duration-1000  h-full p-5 shadow-lg rounded-lg'>
                    ...
                    <div  onClick={() => navigate('/founder')} className='h-10 cursor-pointer w-28 mt-5 md:mt-0 bg-logo_blue flex justify-center items-center rounded-md text-white'>
                      Read More
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 w-[90%] mx-auto mt-10">
            {
              bestofus?.map((best,i) =>{
                return(
                  <div>
                  <img data-aos="zoom-in-up" className='h-60 w-[100%] rounded-md' src={best.img} alt="" />
        ...
        <div className='mt-10 w-[95%] lg:w-[1024px] mx-auto mb-10 bg-logo_white backdrop-blur-3xl shadow-lg   py-14 rounded-lg '>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 mx-auto w-[100%]'>
            ...
            <div data-aos="zoom-in" className='flex flex-col justify-center h-full  items-center   w-[80%] mx-auto text-justify h5   text-white'>
              ...
              <div  data-aos="zoom-in"  className='mt-5 md:mt-5 text-letter-black'>
            ...
            <div data-aos="zoom-in" className='flex flex-col justify-center items-center w-[80%] mx-auto text-justify h5    text-white'>
              ...
              <div className='mt-5 text-letter-black'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis atque quos at dolorum! Delectus quasi deleniti iure dolorem provident corporis ex expedita ullam exercitationem, molestiae eligendi voluptates hic facilis amet ducimus animi sunt, soluta eos quia nihil sint repellendus iste.
              </div>
            </div>
