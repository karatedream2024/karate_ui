  ...
  return (
    <div className=' '>
      <div>
            ...
            <div className='absolute top-10 md:top-10  h-[100%]  w-[100%]  '>
              ...
              <div className='pl-[10%] md:pl-[35%]'>
                <div className='flex mt-0 md:pl-10  lg:mt-10  '>
                  <div className='h5 border bg-logo_green/70 rounded-md text-white border-logo_green h-10 w-[120px] flex items-center justify-center'>
                    Contact us
                  </div>

                  <div className='flex justify-center items-center pl-[20px]'>

                    <div className='h5 border bg-logo_red/70 rounded-md h-10 w-[120px] text-white border-logo_red  flex items-center justify-center'>
                      View
                    </div>
                  </div>
                </div>
        ...
        <div className='h3 text-justify md:w-[80%] mx-auto px-2 md:px-0 my-5'>
      ...
      <div>
        <div className=' md:flex md:[99%] lg:w-[1024px] mx-auto  border-letter-black rounded-lg mt-10  shadow-2xl py-10 md:py-0 p-0 md:p-5'>
          <div  className=''>
          ...
          <div className='h-12 w-28 mt-5 md:mt-0 bg-logo_blue flex justify-center items-center rounded-md text-white'>
            Read More
          </div>
