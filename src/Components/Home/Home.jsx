...
function Home() {
  ...
  const cardData = [ 
    {
    title: 'Disipline',
    desc: "karate helps Regular training helps you stay focused and self-controlled",
  },
  {
    title: 'Self Respect',
    desc: "Karate helps Regular training helps you stay focused and self-controlled.",
  ...
  {
    title: 'Challenges',
    desc: "Karate helps Overcoming challenges makes you stronger, inside and out.",
  ...
  return (
    <div className=' '>
      <div>
        <div>
          <div className='  md:h-screen    relative bg-white'>
              ...
              <div className='grid  grid-cols-1 md:grid-cols-3 md:w-[100%] lg:w-[1024px] md:gap-5  lg:gap-24 text-center' >
                {
                  cardData.map((card, index) => (
                    <div 
                    className=' flex flex-col justify-around bg-logo_white/40 backdrop-blur-lg p-5 shadow-lg hover:scale-105 duration-500 shadow-[#005691] rounded-md h4 text-center  text-[#005691]
                    ' >
            ...
            <div className='absolute top-0  h-[100%]  w-[100%] bg-black opacity-10 '>
            </div>
            <div className='absolute top-10 md:top-10  h-[100%]  w-[100%]  '>
              <div className='w-full' >
                ...
                <div className='h5  text-white  '>
                  ...
                  <div className='h1 p-[5%] md:pl-[15%] md:mt-16 md:py-10 lg:py-10 text-[#E7E8F5] '>
                    Karate - Self Defence
                  </div>
                </div>
                ...
                <div className='pl-[10%] md:pl-[35%]'>
                  <div className='flex mt-0 md:pl-10  lg:mt-10  '>
                    <div onClick={() => navigate('/contact')} className='h5 border hover:scale-105 duration-500 cursor-pointer hover:bg-logo_green bg-logo_green/70 rounded-md text-white border-logo_green h-10 w-[120px] flex items-center justify-center'>
                      Contact us
                    </div>

                    <div className='flex justify-center items-center pl-[20px]'>

                      <div className='h5 border cursor-pointer hover:scale-105 duration-500 hover:bg-[#0a8cbf] bg-[#0a8cbf]/70 rounded-md h-10 w-[120px] text-white border-[#0a8cbf] flex items-center justify-center'>
        ...
        <div>
          <div className='border-2 mt-14 ml-[5%] md:ml-[10%]   border-logo_red text-logo_red px-2 py-1 inline-block rounded-md '>
            WORLD SO KYOKSHION
          </div>

          <div className='h2 text-center mt-4 my-5 text-logo_blue'>
            Tamil Nadu Kyokshion Chinnu'S karate Association
          </div>
          <div className='h4 text-center md:w-[70%] mx-auto px-2 md:px-0 '>
      ...
      <div className='w-[100%] lg:w-[1024px] mx-auto mt-10' >
        <div className='flex justify-center '>
          <div className='grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-5' >
            <div className=' flex justify-center' >
              <img className='h-96 rounded-md  hover:shadow-logo_red duration-1000 flex-col justify-between p-5 shadow-lg ' src={longmaster} alt="" />
            </div>
            <div>
              <div className=' flex flex-col justify-between  hover:shadow-logo_red duration-1000  h-full p-5 shadow-lg rounded-lg'>
                ...
                <div onClick={() => navigate('/founder')} className='h-12 cursor-pointer w-28 mt-5 md:mt-0 bg-logo_blue flex justify-center items-center rounded-md text-white'>
                  Read More
                </div>
